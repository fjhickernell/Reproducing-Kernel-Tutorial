...
\begin{frame}{What Do We Do with Reproducing Kernel Hilbert Spaces?}

\vspace{-5ex}
	\begin{itemize}
		\item Use the Reisz Representation Theorem to derive error bounds for algorithms for linear problems, such as integration, function approximation, solving linear differential equations%
				\uncover<2->{, \alert{BUT}
			\begin{itemize}
		...
		\item Derive optimal algorithms%
		...
		\item Include trends\uncover{, \alert{BUT} I  have not prepared that for today.}
