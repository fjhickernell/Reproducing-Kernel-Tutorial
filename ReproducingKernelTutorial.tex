...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Squared Exponential Kernel}
	
\end{frame}

\begin{frame}{Mat\'ern Kernel}
\end{frame}

\begin{frame}{Centered Discrepancy Kernel}
\end{frame}
...
\begin{itemize}
    ...
    \item $\APP_{\mX,\valpha}(f) = \alpha_{1} f(\vx_1) + \cdots + \alpha_{n} f(\vx_n)$ is the \alert{approximation}
\end{itemize}
...
\begin{align*}
    ...
    - 2 \valpha_\mX^T \SOL\bigl(K(\mX,\cdot) \bigr) + \valpha_\mX^T K(\mX,\mX) \valpha_\mX
\end{align*}
